import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@lyness/cordis-plugin-loader'
 ...
 * (`lyn --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`lyn --dump-config`) so a dump can never drift from what boots. The input
