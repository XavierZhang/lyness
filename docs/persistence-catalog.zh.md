...
'session-log-deepseek/delivery-accepted': {
  ...
  sessionId: import('@lyness/lyn-session/types').SessionId
  ...
  throughSeq: import('@lyness/lyn-session/types').SessionSeq
}
```
