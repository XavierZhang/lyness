...
证据：[已发布产品版本](https://github.com/XavierZhang/lyness/releases/tag/lyn-v0.1.5-alpha.1)及[对应标签的写入器源码](https://github.com/XavierZhang/lyness/blob/lyn-v0.1.5-alpha.1/packages/core/session/src/types.ts)。
