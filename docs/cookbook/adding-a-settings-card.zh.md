...
import type {} from '@lyness/client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "lyn": { "client": { "platform": "web", "inject": ["@lyness/client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@lyness/client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
