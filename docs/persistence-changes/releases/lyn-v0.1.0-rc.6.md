---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.0-rc.6."
kind: persistence-release
---

# Persistence release: lyn-v0.1.0-rc.6

English | [中文](lyn-v0.1.0-rc.6.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.0-rc.6` |
| Source date | 2026-08-13T11:56:40.000Z |
| Release record | Tag only; no release object. |
| Previous release | [lyn-v0.1.0-rc.5](lyn-v0.1.0-rc.5.md) |
...
| This snapshot | [lyn-v0.1.0-rc.6.schema.json](lyn-v0.1.0-rc.6.schema.json) |
