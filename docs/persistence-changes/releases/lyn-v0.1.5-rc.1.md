---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.5-rc.1."
kind: persistence-release
---

# Persistence release: lyn-v0.1.5-rc.1

English | [中文](lyn-v0.1.5-rc.1.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.5-rc.1` |
| Source date | 2026-09-10T01:36:48.000Z |
| Release record | Release object present. |
| Previous release | [lyn-v0.1.5-alpha.2](lyn-v0.1.5-alpha.2.md) |
...
| This snapshot | [lyn-v0.1.5-rc.1.schema.json](lyn-v0.1.5-rc.1.schema.json) |
