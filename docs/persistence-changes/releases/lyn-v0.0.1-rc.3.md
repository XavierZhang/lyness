---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.0.1-rc.3."
kind: persistence-release
---

# Persistence release: lyn-v0.0.1-rc.3

English | [中文](lyn-v0.0.1-rc.3.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.0.1-rc.3` |
| Source date | 2026-08-12T20:18:26.000Z |
| Release record | Tag only; no release object. |
| Previous release | [lyn-v0.0.1-rc.2](lyn-v0.0.1-rc.2.md) |
...
| This snapshot | [lyn-v0.0.1-rc.3.schema.json](lyn-v0.0.1-rc.3.schema.json) |
