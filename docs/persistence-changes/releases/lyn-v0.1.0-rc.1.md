---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.0-rc.1."
kind: persistence-release
---

# Persistence release: lyn-v0.1.0-rc.1

English | [中文](lyn-v0.1.0-rc.1.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.0-rc.1` |
| Source date | 2026-08-13T08:51:36.000Z |
| Release record | Tag only; no release object. |
| Previous release | [lyn-v0.0.1-rc.5](lyn-v0.0.1-rc.5.md) |
...
| This snapshot | [lyn-v0.1.0-rc.1.schema.json](lyn-v0.1.0-rc.1.schema.json) |
