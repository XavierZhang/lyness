---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.0-rc.5."
kind: persistence-release
---

# Persistence release: lyn-v0.1.0-rc.5

English | [中文](lyn-v0.1.0-rc.5.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.0-rc.5` |
| Source date | 2026-08-13T11:38:46.000Z |
| Release record | Tag only; no release object. |
| Previous release | [lyn-v0.1.0-rc.3](lyn-v0.1.0-rc.3.md) |
...
| This snapshot | [lyn-v0.1.0-rc.5.schema.json](lyn-v0.1.0-rc.5.schema.json) |
