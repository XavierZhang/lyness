---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.0.1-rc.1."
kind: persistence-release
---

# Persistence release: lyn-v0.0.1-rc.1

English | [中文](lyn-v0.0.1-rc.1.zh.md)

## Summary

This is the earliest available LYN alpha/rc tag and establishes the historical baseline: 42 persistence roots and writer format 0.
...
| This snapshot | [lyn-v0.0.1-rc.1.schema.json](lyn-v0.0.1-rc.1.schema.json) |
