---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.2-alpha.5."
kind: persistence-release
---

# Persistence release: lyn-v0.1.2-alpha.5

English | [中文](lyn-v0.1.2-alpha.5.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.2-alpha.5` |
| Source date | 2026-09-02T07:57:43.000Z |
| Release record | Release object present. |
| Previous release | [lyn-v0.1.2-alpha.4](lyn-v0.1.2-alpha.4.md) |
...
| This snapshot | [lyn-v0.1.2-alpha.5.schema.json](lyn-v0.1.2-alpha.5.schema.json) |
...
schemaVersion: 1
tag: lyn-v0.1.2-alpha.5
previous: lyn-v0.1.2-alpha.4
