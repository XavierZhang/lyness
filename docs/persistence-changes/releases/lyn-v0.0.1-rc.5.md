---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.0.1-rc.5."
kind: persistence-release
---

# Persistence release: lyn-v0.0.1-rc.5

English | [中文](lyn-v0.0.1-rc.5.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.0.1-rc.5` |
| Source date | 2026-08-12T22:18:58.000Z |
| Release record | Tag only; no release object. |
| Previous release | [lyn-v0.0.1-rc.4](lyn-v0.0.1-rc.4.md) |
...
| This snapshot | [lyn-v0.0.1-rc.5.schema.json](lyn-v0.0.1-rc.5.schema.json) |
