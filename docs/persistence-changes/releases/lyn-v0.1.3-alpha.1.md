---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.3-alpha.1."
kind: persistence-release
---

# Persistence release: lyn-v0.1.3-alpha.1

English | [中文](lyn-v0.1.3-alpha.1.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.3-alpha.1` |
| Source date | 2026-09-04T09:16:23.000Z |
| Release record | Release object present. |
| Previous release | [lyn-v0.1.2-rc.1](lyn-v0.1.2-rc.1.md) |
...
| This snapshot | [lyn-v0.1.3-alpha.1.schema.json](lyn-v0.1.3-alpha.1.schema.json) |
...
schemaVersion: 1
tag: lyn-v0.1.3-alpha.1
previous: lyn-v0.1.2-rc.1
