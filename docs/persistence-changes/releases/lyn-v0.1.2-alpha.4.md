---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.2-alpha.4."
kind: persistence-release
---

# Persistence release: lyn-v0.1.2-alpha.4

English | [中文](lyn-v0.1.2-alpha.4.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.2-alpha.4` |
| Source date | 2026-09-01T15:37:26.000Z |
| Release record | Release object present. |
| Previous release | [lyn-v0.1.2-alpha.3](lyn-v0.1.2-alpha.3.md) |
...
| This snapshot | [lyn-v0.1.2-alpha.4.schema.json](lyn-v0.1.2-alpha.4.schema.json) |
...
schemaVersion: 1
tag: lyn-v0.1.2-alpha.4
previous: lyn-v0.1.2-alpha.3
