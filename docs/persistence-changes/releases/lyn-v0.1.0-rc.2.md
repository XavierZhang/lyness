---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.0-rc.2."
kind: persistence-release
---

# Persistence release: lyn-v0.1.0-rc.2

English | [中文](lyn-v0.1.0-rc.2.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.0-rc.2` |
| Source date | 2026-08-13T09:23:52.000Z |
| Release record | Tag only; no release object. |
| Previous release | [lyn-v0.1.0-rc.1](lyn-v0.1.0-rc.1.md) |
...
| This snapshot | [lyn-v0.1.0-rc.2.schema.json](lyn-v0.1.0-rc.2.schema.json) |
