---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.2-alpha.2."
kind: persistence-release
---

# Persistence release: lyn-v0.1.2-alpha.2

English | [中文](lyn-v0.1.2-alpha.2.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.2-alpha.2` |
| Source date | 2026-08-30T13:37:53.000Z |
| Release record | Release object present. |
| Previous release | [lyn-v0.1.2-alpha.1](lyn-v0.1.2-alpha.1.md) |
...
| This snapshot | [lyn-v0.1.2-alpha.2.schema.json](lyn-v0.1.2-alpha.2.schema.json) |
...
schemaVersion: 1
tag: lyn-v0.1.2-alpha.2
previous: lyn-v0.1.2-alpha.1
