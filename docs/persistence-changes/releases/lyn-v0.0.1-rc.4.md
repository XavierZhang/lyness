---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.0.1-rc.4."
kind: persistence-release
---

# Persistence release: lyn-v0.0.1-rc.4

English | [中文](lyn-v0.0.1-rc.4.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.0.1-rc.4` |
| Source date | 2026-08-12T21:29:23.000Z |
| Release record | Tag only; no release object. |
| Previous release | [lyn-v0.0.1-rc.3](lyn-v0.0.1-rc.3.md) |
...
| This snapshot | [lyn-v0.0.1-rc.4.schema.json](lyn-v0.0.1-rc.4.schema.json) |
