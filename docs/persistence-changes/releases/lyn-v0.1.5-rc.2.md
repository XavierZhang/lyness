---
description: "Retrospective Session persistence types and adjacent-release changes for lyn-v0.1.5-rc.2."
kind: persistence-release
---

# Persistence release: lyn-v0.1.5-rc.2

English | [中文](lyn-v0.1.5-rc.2.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `lyn-v0.1.5-rc.2` |
| Source date | 2026-09-10T13:50:19.000Z |
| Release record | Release object present. |
| Previous release | [lyn-v0.1.5-rc.1](lyn-v0.1.5-rc.1.md) |
...
| This snapshot | [lyn-v0.1.5-rc.2.schema.json](lyn-v0.1.5-rc.2.schema.json) |
