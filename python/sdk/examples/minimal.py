...
def main() -> None:
    ...
    configured_home = os.environ.get("LYNESS_HOME", "")
    ...
    parser.add_argument("--model", default=os.environ.get("LYNESS_MODEL", "deepseek-v4-flash"))
    parser.add_argument("--max-tokens", type=int)
    args = parser.parse_args()
    if args.lyn_home is None:
        parser.error("--lyn-home or a non-empty LYNESS_HOME is required")

    workspace = args.workspace.resolve()
    lyn_home = args.lyn_home.resolve()
    with Lyness(
