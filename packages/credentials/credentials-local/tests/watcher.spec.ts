...
const KEY = credentialRef('LYNESS_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'lyn-credentials-watch-'))
