...
const ALPHA = credentialRef('LYNESS_REVIEW_ALPHA')
const BETA = credentialRef('LYNESS_REVIEW_BETA')
const INNER = credentialRef('LYNESS_REVIEW_INNER')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'lyn-cred-review-'))
