...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-storage-json) is the exhaustive source for every accepted field and its JSDoc.
