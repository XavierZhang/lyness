/**
 * Package-owned invariant companion for `@lyness/lyn-storage-domain`: every
 ...
 * @module @lyness/lyn-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@lyness/lyn-storage-domain'
