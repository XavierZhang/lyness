/**
 * Package-owned invariant companion for `@lyness/util-workspace-path`.
 * @module @lyness/util-workspace-path/invariant
 */
...
const PACKAGE_NAME = '@lyness/util-workspace-path'
