 ...
 * @returns the `lyn-resource://file/…` address.
 */
 ...
 * @param base - HTTP(S) application base, including its deployment prefix, or `lyn-app://app/`.
...
export function fileMediaUrl(base: string, path: string): string | undefined {
  if ((!/^https?:/u.test(base) && !base.startsWith('lyn-app://app/')) || !isAbsoluteWorkspacePath(path)
