...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-api-settings-controller) is the exhaustive source for accepted fields and their JSDoc.
