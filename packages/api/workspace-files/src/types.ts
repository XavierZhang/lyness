 ...
 *   resource system, whose `lyn-resource://file/session/<id>/<path>` address carries that
 *   same path.
...
export interface WorkspaceFileStat {
   ...
   * on Windows. What a `lyn-resource://file/absolute/…` address carries, and
   * what a `lyn-resource://file/session/<sessionId>/…` address's
