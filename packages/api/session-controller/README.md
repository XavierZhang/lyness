...
Background-job rows and observation streams belong to [`lyn-api-job-controller`](../job-controller/README.md); the control stream carries projections only.
...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-api-session-controller) is the exhaustive source for accepted fields and their JSDoc.
