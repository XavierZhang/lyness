...
import { createClientTest, webApp, type TestClient } from '@lyness/lyn-client-test-runtime/src/assembly/index.ts'
...
const it = createClientTest({ roster: webApp.closure(['@lyness/lyn-api-gateway']) })
