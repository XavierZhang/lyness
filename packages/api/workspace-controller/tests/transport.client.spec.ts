...
import { RemoteStreamCarrierError, type ClientRemote } from '@lyness/lyn-api-gateway/client'
import { SessionId } from '@lyness/lyn-session/types'
import { RemoteError } from '@lyness/lyn-typert-protocol'
import { frames, openStream, type RemoteMock, type StreamScript } from '@lyness/lyn-remote-mock'
...
const SELF = '@lyness/lyn-api-workspace-controller'
