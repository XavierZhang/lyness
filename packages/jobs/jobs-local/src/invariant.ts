/**
 * Package-owned invariant companion for `@lyness/jobs-local`.
 * @module @lyness/jobs-local/invariant
 */
...
const PACKAGE_NAME = '@lyness/jobs-local'
...
/**
 * No runtime invariant: `@lyness/jobs/invariant` owns per-snapshot identity, status,
