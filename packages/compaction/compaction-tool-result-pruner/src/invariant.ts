/**
 * Package-owned invariant companion for `@lyness/compaction-tool-result-pruner`.
 * @module @lyness/compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@lyness/compaction-tool-result-pruner'
