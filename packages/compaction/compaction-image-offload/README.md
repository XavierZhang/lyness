...
# @lyness/lyn-compaction-image-offload
...
- [lyn-llm](../../llm/llm/README.md) — `ImageBlock.offloaded`, `IMAGE_OFFLOAD_REQUIRED`, and the placeholder projection.
