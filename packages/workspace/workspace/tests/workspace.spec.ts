...
import type { StorageBackend } from '@lyness/storage'
...
import { SessionPersistenceRevision } from '@lyness/session-persistence'
import type { SessionPersistenceSnapshot } from '@lyness/session-persistence'
