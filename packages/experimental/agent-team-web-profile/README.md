...
```sh
pnpm lyn plugin --profile web add ./packages/experimental/agent-team-profile
pnpm lyn plugin --profile web add ./packages/experimental/agent-team-web-profile
```
