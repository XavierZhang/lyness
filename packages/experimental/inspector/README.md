...
The generated [configuration catalog](../../../docs/config-catalog.md#lynessexperimental-inspector) is the exhaustive source for accepted fields and their declarations.
