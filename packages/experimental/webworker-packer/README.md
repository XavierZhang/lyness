...
The [`LynConfigTreeDeclaration`](../../util/package-manifest/README.md) type describes each `lyn.configTrees` entry; this packer validates it and resolves its source directory.
