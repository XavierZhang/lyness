...
import SpeechToText from '@lyness/lyn-experimental-speech-to-text'
import { afterEach, expect, it, vi } from 'vitest'
import type { SpeechPreparationState } from '@lyness/lyn-experimental-speech-to-text/types'
...
async function fixture() {
  const root = await mkdtemp(join(tmpdir(), 'lyn-speech-onnx-')); roots.push(root)
