 ...
 * @module @lyness/lyn-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process
 */
...
import { LYNESS_ROOT } from '../../../storage/paths.ts'
...
export function spawn(
  ...
  queueMicrotask(() => {
    void (async () => {
      const cwd = options.cwd ?? LYNESS_ROOT
