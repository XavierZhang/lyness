 ...
 * @module @lyness/lyn-experimental-webworker-runtime/src/storage/memory
 */
...
// stored value — the round-trip consumers like lyn-credentials-local's
 ...
 */
export function loadVfsImage(image: Uint8Array, root = '/lyn', vfs = new MemoryVfs()): MemoryVfs {
