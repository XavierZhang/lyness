...
import { LYNESS_HOME, LYNESS_TMP } from '../../src/storage/paths.ts'
...
describe('replaced external packages', () => {
  it('lists the packages the loader serves from the bundle', () => {
    ...
    expect(REPLACED_EXTERNAL_PACKAGES).not.toContain('@lyness/node-addon-system')
    expect(REPLACED_EXTERNAL_PACKAGES).not.toContain('@lyness/node-addon-system/landlock-run')
