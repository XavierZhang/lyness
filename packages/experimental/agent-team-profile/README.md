---
description: "Private Agent Teams profile layer over lyn-base, for source-checkout users who want Team-scoped coordination tools while retaining one-shot delegation."
kind: "package-bundle"
---
...
The bundle adds the Team policy and tool schemas described by `lyn-tool-team`; it adds no prompt text of its own.
