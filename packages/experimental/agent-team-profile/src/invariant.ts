/**
 * Package-owned invariant companion for `@lyness/experimental-agent-team-profile`.
 * @module @lyness/experimental-agent-team-profile/invariant
 */

import type { Context } from '@lyness/cordis'
import type { InvariantInstaller } from '@lyness/invariants'

const PACKAGE_NAME = '@lyness/experimental-agent-team-profile'
