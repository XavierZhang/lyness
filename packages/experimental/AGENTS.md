...
- Every package here uses the `@lyness/experimental-*` npm prefix, sets `private: true`, and omits `publishConfig`; the workspace constraints gate enforces these declarations and the lyn release family excludes this directory.
