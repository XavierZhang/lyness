...
import type { HostObservable, InjectFace, PropsLocale, PropsRuntime } from '@lyness/lyn-client-ui-slots'
import type { TokenSpan } from '@lyness/lyn-client-ui-conversation/client'
import type { TranscriptionRequest } from '@lyness/lyn-experimental-api-speech-to-text/types'
import type { SpeechPreparationOptions, SpeechProviderId, SpeechSelection, SpeechSelectionPatch, Transcript } from '@lyness/lyn-experimental-speech-to-text/types'
...
import { Button, IconCloseOutlineRegular, IconStopFillRegular, IconMicrophoneOutlineRegular, StateDot, Tooltip } from '@lyness/lyn-client-ui-primitives'
