...
import type { SpeechPreparationState, SpeechPreparationStep, SpeechProviderId } from '@lyness/lyn-experimental-speech-to-text/types'
...
it('explains download failures on the Host machine and retains an actionable retry', () => {
  ...
  expect(alert.textContent).toContain('运行 LYN 的机器的 DNS 和代理设置')
