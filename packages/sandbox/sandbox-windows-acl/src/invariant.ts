/**
 * Package-owned invariant companion for `@lyness/sandbox-windows-acl`.
 * @module @lyness/sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@lyness/sandbox-windows-acl'
