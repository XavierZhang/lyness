---
description: "Package map for verified external events, programmatic rules, and fire-and-forget LYN Session creation."
kind: "package-group"
---

# webhook/ — verified external events to LYN Sessions
