/**
 * Package-owned invariant companion for `@lyness/web-search-deepseek`.
 * @module @lyness/web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@lyness/web-search-deepseek'
