...
The generated [configuration catalog](../../../docs/config-catalog.md#lynessweb-search-exa) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynessweb-search-exa) — every accepted config field and its source declaration.
