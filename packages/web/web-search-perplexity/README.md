...
The generated [configuration catalog](../../../docs/config-catalog.md#lynessweb-search-perplexity) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynessweb-search-perplexity) — every accepted config field and its source declaration.
