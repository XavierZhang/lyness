/**
 * Package-owned invariant companion for `@lyness/tool-pwsh-persistent`.
 * @module @lyness/tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@lyness/tool-pwsh-persistent'
