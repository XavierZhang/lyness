...
import type { ShellExecRequest, ShellExecSpec, ShellExecution, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@lyness/lyn-shell'
...
export class LocalBashExecutor extends ShellExecutor {
  ...
  resolve(request: ShellExecRequest): ShellExecSpec {
    ...
    return {
      ...
      // Carry stdin/ordinary env/trusted lynEnv through verbatim — optional,
  ...
  private spawnSpec(
    ...
    return {
      ...
      signal,
      // One explicit env map for the seam, layered so the trusted lynEnv
