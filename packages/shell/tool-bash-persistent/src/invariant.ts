/**
 * Package-owned invariant companion for `@lyness/tool-bash-persistent`.
 * @module @lyness/tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@lyness/tool-bash-persistent'
