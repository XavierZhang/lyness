/**
 * Package-owned invariant companion for `@lyness/repeat-tool-reminder`.
 * @module @lyness/repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@lyness/repeat-tool-reminder'
