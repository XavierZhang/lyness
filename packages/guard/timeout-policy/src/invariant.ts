/**
 * Package-owned invariant companion for `@lyness/tool-call-timeout-policy`.
 * @module @lyness/tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@lyness/tool-call-timeout-policy'
