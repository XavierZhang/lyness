...
- **Channel-neutral library.** The package carries no loader hooks and no dev-mode surface; the [`lyn` app](../../../apps/cli/README.md) owns its Node source-launch hook and consumes these helpers for the boot sequence, and built consumers use plain Node package resolution.
