...
import Loader, { EntryGroup, ModuleLoader, isJsExpr, type EntryOptions } from '@lyness/cordis-plugin-loader'
    ...
    const carrier = async (plugin: unknown, baseUrl: string): Promise<'group' | 'include' | undefined> => {
      ...
      if (resolved === undefined) {
        ...
        resolved = Promise.allSettled([
          loader.import('@lyness/cordis-plugin-group', baseUrl, {}),
          loader.import('@lyness/cordis-plugin-include', baseUrl, {}),
        ]).then(([group, include]) => {
