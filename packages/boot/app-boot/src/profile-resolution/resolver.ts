...
import type { ModuleLoaderV1, ModuleLoaderV2, ResolveResult } from '@lyness/cordis-plugin-loader'
...
const WORKER_RESOLUTION_KEY = '@lyness/lyn-app-boot/profile-resolution'
