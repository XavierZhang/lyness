...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-fs-local) is the exhaustive source for every accepted field and its JSDoc.
