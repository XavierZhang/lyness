/**
 * Package-owned invariant companion for `@lyness/tool-str-replace-editor`.
 * @module @lyness/tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@lyness/tool-str-replace-editor'
