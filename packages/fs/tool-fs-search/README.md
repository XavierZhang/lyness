...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesstool-fs-search) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#lynesstool-fs-search) — the exhaustive schemas this package registers.
...
The glob description states the configured over-cap ordering. The generated [`glob` and `grep` schemas](../../../docs/tool-catalog.md#lynesstool-fs-search) use `sampleOverCapGlobResults: true`; the tools are registered unconditionally.
