/** JSON string-prefix accounting for the outer-output ledger. @module @lyness/lyn-ptc-runtime-node/output-json */

import type { PtcJsonValue } from '@lyness/lyn-ptc-runtime'
