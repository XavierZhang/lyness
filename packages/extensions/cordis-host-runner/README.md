...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesscordis-host-runner) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesscordis-host-runner) — every accepted config field.
