...
- [Generated tool catalog](../../docs/tool-catalog.md#lynesslyn-tool-cordis) — the seven model-facing tool schemas.
- [Generated configuration catalog](../../docs/config-catalog.md#lynesslyn-cordis-host-runner) — the runner's accepted config fields.
