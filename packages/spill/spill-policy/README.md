...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-spill-policy) is the exhaustive source for every accepted field. A negative or fractional cap fails plugin load rather than corrupting per-call behavior.
