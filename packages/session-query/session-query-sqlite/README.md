...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-session-query-sqlite) is the exhaustive source for every accepted field and its JSDoc.
