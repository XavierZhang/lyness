/**
 * Package-owned invariant companion for `@lyness/session-query-sqlite`.
 * @module @lyness/session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@lyness/session-query-sqlite'
