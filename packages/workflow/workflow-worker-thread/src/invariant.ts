/**
 * Package-owned invariant companion for `@lyness/workflow-worker-thread`.
 * @module @lyness/workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@lyness/workflow-worker-thread'
