/**
 * Package-owned invariant companion for `@lyness/session-persistence-sqlite`.
 * @module @lyness/session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@lyness/session-persistence-sqlite'
