 ...
 * (`deriveStats` in lyn-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @lyness/lyn-session-stats/projection
 */

import { z } from 'zod'
import { assistantStreamFirstTokenTime } from '@lyness/lyn-llm'
