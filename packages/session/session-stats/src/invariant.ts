/**
 * Package-owned invariant companion for `@lyness/session-stats`.
 * @module @lyness/session-stats/invariant
 */
...
const PACKAGE_NAME = '@lyness/session-stats'
 ...
 * ids) are owned and runtime-checked by lyn-agent-loop and the session
 * surface, not here.
 */
