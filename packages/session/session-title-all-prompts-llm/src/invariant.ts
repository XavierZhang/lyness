/**
 * Package-owned invariant companion for `@lyness/session-title-all-prompts-llm`.
 * @module @lyness/session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@lyness/session-title-all-prompts-llm'
