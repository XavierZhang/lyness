/**
 * Package-owned invariant companion for `@lyness/session-title-first-prompt-llm`.
 * @module @lyness/session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@lyness/session-title-first-prompt-llm'
