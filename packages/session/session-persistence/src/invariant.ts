/**
 * Package-owned invariant companion for `@lyness/session-persistence`.
 * @module @lyness/session-persistence/invariant
 */
...
const PACKAGE_NAME = '@lyness/session-persistence'
