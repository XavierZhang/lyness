/**
 * OpenTelemetry Service Provider for the lyness telemetry capability.
 *
...
// version (same pattern as lyn-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ops = this.provider.getLogger('@lyness/session-telemetry-otel/ops', version)
