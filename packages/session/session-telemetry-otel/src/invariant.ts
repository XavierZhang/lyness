/**
 * Package-owned invariant companion for `@lyness/session-telemetry-otel`.
 * @module @lyness/session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@lyness/session-telemetry-otel'
