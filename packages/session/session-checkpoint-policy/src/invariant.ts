/**
 * Package-owned invariant companion for `@lyness/session-checkpoint-policy`.
 * @module @lyness/session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@lyness/session-checkpoint-policy'
