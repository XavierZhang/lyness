...
import { SessionFormatUnsupportedError, SessionPersistenceCorruptionError } from '@lyness/lyn-session-persistence'
...
beforeEach(async () => {
  root = await mkdtemp(join(tmpdir(), 'lyn-migration-refusal-'))
})
