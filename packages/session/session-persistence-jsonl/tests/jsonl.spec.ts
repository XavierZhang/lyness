import { MessageId, createMessage } from '@lyness/llm'
...
import { SESSION_FORMAT_VERSION, SessionLogOffset, SessionSeq, SessionId } from '@lyness/session'
  ...
  return [
    ...log.slice(0, 2),
    {
      ...
      data: { turn: 1, step: 1, message: {
        ...
        role: 'system', content: [], source: { kind: 'plugin', plugin: '@lyness/system-prompt' },
      } },
    },
