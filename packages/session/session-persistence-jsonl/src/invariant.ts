/**
 * Package-owned invariant companion for `@lyness/session-persistence-jsonl`.
 * @module @lyness/session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@lyness/session-persistence-jsonl'
