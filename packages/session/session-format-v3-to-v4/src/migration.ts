...
import { defineSessionFormatMigration, SessionFormatError, SessionFormatUnsupportedMigrationError, isSessionFormatJsonObject, sessionFormatCount } from '@lyness/lyn-session-format'
import type { SessionFormatEvent, SessionFormatEventRun, SessionFormatJsonObject, SessionFormatJsonValue, SessionFormatMigration, SessionFormatMigrationContext, SessionFormatMigrationStage, SessionFormatMigrationStageInput } from '@lyness/lyn-session-format'
import { assertReleasedV3Header } from '@lyness/lyn-session-format-v2-to-v3'
...
export const sessionFormatV3ToV4 = defineSessionFormatMigration({
  name: '@lyness/lyn-session-format-v3-to-v4',
  fromVersion: 3,
  toVersion: 4,
