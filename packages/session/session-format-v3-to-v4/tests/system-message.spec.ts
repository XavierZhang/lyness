...
import { SessionFormatEventCollector, type SessionFormatEvent } from '@lyness/lyn-session-format'
...
for (const event of [
  ...
  { type: 'system/message', seq: 2, time: 1, surfaceOp: 'append', data: { turn: 1, step: 1, message: {
    id: 'system', role: 'system', source: { kind: 'plugin', plugin: '@lyness/lyn-system-prompt' }, content: [],
  } } },
