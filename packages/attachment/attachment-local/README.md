...
The generated [configuration catalog](../../../docs/config-catalog.md#lynessattachment-local) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynessattachment-local) — every accepted config field and its source declaration.
