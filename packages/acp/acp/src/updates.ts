/** Standard ACP updates derived from committed LYN session events. */
 ...
 * @param event - committed LYN tool-call event.
 ...
 * @param event - committed LYN tool-result event.
...
/** Report current context occupancy only when LYN has both usage and capacity facts. */
