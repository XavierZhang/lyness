/** Standard ACP MCP-server declarations translated into Agent-scoped LYN MCP clients. */
...
import * as McpClient from '@lyness/lyn-mcp-client'
...
/** Produce a stable LYN tool namespace from ACP's human-readable server name. */
