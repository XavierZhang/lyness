...
import { applyEntryPatches } from '@lyness/cordis-plugin-include'
import { loadOverlayPatches } from '@lyness/lyn-app-boot'
import * as Browser from '@lyness/lyn-client-ui-sidebar-browser'
...
it.each([
  ...
  expect(rows[0]!.name).toBe('@lyness/lyn-client-ui-sidebar-browser')
