/**
 * The bundle's substance is its patch file: the `lyn.bundle.patch` manifest
...
describe('lyn-base bundle', () => {
  it('declares a parseable patch list through the lyn.bundle.patch manifest field', () => {
