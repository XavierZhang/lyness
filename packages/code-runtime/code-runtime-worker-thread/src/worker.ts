 ...
 * @module @lyness/lyn-code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('lyn-code-runtime-worker-thread: worker entry loaded outside a worker thread')
