/**
 * Package-owned invariant companion for `@lyness/code-runtime-worker-thread`.
 * @module @lyness/code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@lyness/code-runtime-worker-thread'
