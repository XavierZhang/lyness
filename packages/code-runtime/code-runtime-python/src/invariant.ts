/**
 * Package-owned invariant companion for `@lyness/code-runtime-python`.
 * @module @lyness/code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@lyness/code-runtime-python'
