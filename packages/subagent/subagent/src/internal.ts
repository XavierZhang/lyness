...
export const adjacentAgentSendMessageTool = Symbol.for('lyn.subagent.adjacentAgentSendMessageTool')
 ...
 * @internal
 */
export const deliverSubagentPrompt = Symbol.for('lyn.subagent.deliverPrompt')
