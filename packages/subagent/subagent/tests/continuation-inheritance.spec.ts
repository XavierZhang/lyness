...
import SandboxPolicyService, { effectiveSandboxMode, setSandboxMode } from '@lyness/sandbox-policy'
...
import ApprovalService, { effectiveApprovalPolicy } from '@lyness/user-approval'
...
async function setup(script: Script) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'lyn-continuation-inherit-'))
  roots.push(root)
