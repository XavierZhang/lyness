...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-subagent-acp) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesslyn-subagent-acp) — every accepted config field and its source declaration.
