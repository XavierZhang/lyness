/**
 * Package-owned invariant companion for `@lyness/tool-subagent-control`.
 * @module @lyness/tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@lyness/tool-subagent-control'
