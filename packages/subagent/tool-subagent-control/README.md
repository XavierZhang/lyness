...
The generated [schemas](../../../docs/tool-catalog.md#lynesstool-subagent-control): `send_message` takes `agent_id` and `message`; `interrupt_agent` takes `agent_id`; `list_agents` takes the optional `scope` enum.
