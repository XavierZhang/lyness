/**
 * Package-owned invariant companion for `@lyness/subagent-lyn-sdk`.
 * @module @lyness/subagent-lyn-sdk/invariant
 */
...
const PACKAGE_NAME = '@lyness/subagent-lyn-sdk'

/** Cordis companion plugin name. */
export const name = 'subagent-lyn-sdk-invariant'
