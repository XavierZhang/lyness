...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesssubagent-lyn-sdk) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesssubagent-lyn-sdk) — every accepted config field and its source declaration.
