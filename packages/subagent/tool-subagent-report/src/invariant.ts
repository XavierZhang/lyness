/**
 * Package-owned invariant companion for `@lyness/tool-subagent-report`.
 * @module @lyness/tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@lyness/tool-subagent-report'
