...
- name: '@lyness/subagent-fork-in-process'
...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesssubagent-fork-in-process) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesssubagent-fork-in-process) — every accepted config field and its source declaration.
