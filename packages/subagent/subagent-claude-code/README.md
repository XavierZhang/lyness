...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesssubagent-claude-code) — every accepted config field and its source declaration.
