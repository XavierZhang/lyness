...
```yaml
- name: '@lyness/file-reference-local'
  config:
    maxResults: 20
```
...
- [Filesystem tool catalog](../../../docs/tool-catalog.md#lynesstool-fs) — the `read` tool whose namespace discovery must match.
