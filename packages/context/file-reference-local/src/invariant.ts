/**
 * Package-owned invariant companion for `@lyness/file-reference-local`.
 * @module @lyness/file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@lyness/file-reference-local'
