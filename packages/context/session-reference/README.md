...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesssession-reference) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesssession-reference) — every accepted config field and its source declaration.
