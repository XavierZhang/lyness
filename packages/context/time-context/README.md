...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesstime-context) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesstime-context) — every accepted config field and its source declaration.
