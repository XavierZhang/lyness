...
import { Config, plainOptions, resolveAdapterOptions } from '@lyness/lyn-llm-deepseek-api-key'
import type { ResolvedDeepSeekOptions as DeepSeekConnectionOptions } from '@lyness/lyn-llm-deepseek-api-key'
