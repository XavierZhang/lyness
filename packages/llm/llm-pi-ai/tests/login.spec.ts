...
import type { AuthorizationInteraction, AuthorizationNotice, AuthorizationPrompt } from '@lyness/lyn-authorization'
...
async function harness(): Promise<Context> {
  const dir = await mkdtemp(join(tmpdir(), 'lyn-pi-login-'))
  dirs.push(dir)
