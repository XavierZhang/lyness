...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@lyness/authorization'
import { isCredentialKeySegment } from '@lyness/credentials'
