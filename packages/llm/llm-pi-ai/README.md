...
The generated [configuration catalog](../../../docs/config-catalog.md#lynessllm-pi-ai) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynessllm-pi-ai) — every accepted config field and its source declaration.
