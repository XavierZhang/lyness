...
import type {} from '@lyness/lyn-host-product-telemetry-otel'
...
try {
  ...
  process.env.LYNESS_APP_VERSION = 'synthetic-release'
  process.env.LYNESS_PRODUCT_TELEMETRY_TEST_ENDPOINT = `http://127.0.0.1:${address.port}/v1/logs`
