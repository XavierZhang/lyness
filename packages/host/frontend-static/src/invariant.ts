/**
 * Package-owned invariant companion for `@lyness/host-frontend-static`.
 * @module @lyness/host-frontend-static/invariant
 */

import type { Context } from '@lyness/cordis'
import type { InvariantInstaller } from '@lyness/invariants'

const PACKAGE_NAME = '@lyness/host-frontend-static'
