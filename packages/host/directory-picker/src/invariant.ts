/** Package-owned invariant companion for the directory-picker seam. @module @lyness/host-directory-picker/invariant */

import type { Context } from '@lyness/cordis'
import type { InvariantInstaller } from '@lyness/invariants'

const PACKAGE_NAME = '@lyness/host-directory-picker'
