...
/**
 * Tail script settling the boot-readiness deferred (`__LYNESS_BOOT_READY__`):
 ...
 */
const READY_MARKUP = '<script>(globalThis.__LYNESS_BOOT_READY__ ??= Promise.withResolvers()).resolve()</script>'
