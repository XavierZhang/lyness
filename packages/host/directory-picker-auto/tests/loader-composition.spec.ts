...
async function loadComposition(
  ...
  context = new Context()
  if (options.launchEnvironment !== undefined) context.provide(LYNESS_LAUNCH_ENVIRONMENT_KEY, options.launchEnvironment)
...
function stubAttendedHost(): void {
  fakeBin = mkdtempSync(join(tmpdir(), 'lyn-picker-bin-'))
