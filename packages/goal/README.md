...
- [Generated tool catalog](../../docs/tool-catalog.md#lynesstool-goal) — the three goal-tool schemas the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#lynessgoal) — every accepted config field of the goal service.
