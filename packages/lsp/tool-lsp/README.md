...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-tool-lsp) is the exhaustive source for every accepted field.
...
The model sees the generated [`lsp` schema](../../../docs/tool-catalog.md#lynesslyn-tool-lsp).
