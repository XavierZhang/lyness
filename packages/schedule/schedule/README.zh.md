...
[生成的工具目录](../../../docs/tool-catalog.zh.md#lynesslyn-schedule) 包含 `schedule_create`、`schedule_list`、`schedule_delete` 和 `schedule_update` 的描述与 schema；Schedule 加载期间，这些工具注册在活动根 Agent 的作用域中。
