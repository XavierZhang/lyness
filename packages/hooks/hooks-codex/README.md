...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-hooks-codex) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesslyn-hooks-codex) — every accepted config field and its source declaration.
