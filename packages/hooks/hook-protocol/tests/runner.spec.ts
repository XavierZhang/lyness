...
import type { ShellExecRequest, ShellExecSpec, ShellExecutor, ShellRunResult } from '@lyness/lyn-shell'
 ...
 * executor (lyn-bash-local) is exercised end-to-end by the hook-bridge plugins
