---
description: "Shared Workspace browser and picker plugin for the lyn web client: grouped or flat session rows, management actions, the slot-composed Session row actions, and directory picking."
...
import { MenuItemButton } from '@lyness/lyn-client-ui-primitives'
import type {
