/**
 * Package-owned invariant companion for `@lyness/client-ui-workspace`.
 * @module @lyness/client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-workspace'
