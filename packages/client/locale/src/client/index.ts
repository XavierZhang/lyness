...
import type { ConfigForm } from '@lyness/lyn-client-ui-settings/client'
...
export type { Translate, TranslateNS } from '@lyness/lyn-client-ui-slots'
...
export class LocaleRuntime {
   ...
   * different browser sharing the same LYN home. Only the render notification
...
export async function apply(ctx: ClientContext): Promise<void> {
  const bridge = (globalThis as { __LYNESS_LOCALE__?: LocaleBridge }).__LYNESS_LOCALE__
