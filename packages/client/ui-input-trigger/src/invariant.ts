/**
 * Package-owned invariant companion for `@lyness/client-ui-input-trigger`.
 * @module @lyness/client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-input-trigger'
