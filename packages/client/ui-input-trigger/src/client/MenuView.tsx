 ...
 */
import { MenuSurface } from '@lyness/lyn-client-ui-primitives'
import { Fragment, useCallback, useEffect, useLayoutEffect, useRef, useState, useSyncExternalStore } from 'react'
import clsx from 'clsx'
import { IconChevronRightOutlineRegular, ReferenceIconRegular, useAnchoredMaxHeight } from '@lyness/lyn-client-ui-primitives'
...
function optionId(source: string, index: number): string {
  return `lyn-slash-option-${source}-${index}`
}
