...
import { bindSnapshotSelector, SlotTestRuntime, stubConfigForm } from '@lyness/lyn-client-test-runtime'
...
import * as localePlugin from '@lyness/lyn-client-locale/client'
