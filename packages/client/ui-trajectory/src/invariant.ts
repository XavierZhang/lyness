/**
 * Package-owned invariant companion for `@lyness/client-ui-trajectory`.
 * @module @lyness/client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-trajectory'
