...
import type { SidebarRightTabDefinition, SidebarRightTabParamsMap, SidebarRightNavigationParams } from '@lyness/lyn-client-ui-sidebar-right/client'
import type { ScheduleId } from '@lyness/lyn-schedule/client'
import type { SessionId } from '@lyness/lyn-session/types'

/** This implementation's identity in the tab system: the key its body and title register under. */
export const SCHEDULE_TASK_ID = '@lyness/lyn-client-ui-schedule/task'
