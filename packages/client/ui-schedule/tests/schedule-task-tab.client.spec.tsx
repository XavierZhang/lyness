...
import type { PaneId, SidebarRightTabActions, SidebarRightTabInfo } from '@lyness/lyn-client-ui-sidebar-right/client'
import type { ScheduleCatalogEntry, ScheduleId } from '@lyness/lyn-schedule/client'
