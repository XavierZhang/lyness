...
import { resolveSlotLabel, type HostObservable, type StoredEntry } from '@lyness/lyn-client-ui-slots'
...
import type { ScheduleId, ScheduleCatalogEntry, ScheduleUpdateRequest, ScheduleUpdateResult } from '@lyness/lyn-schedule/client'
