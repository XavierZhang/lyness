...
import type { ScheduleCatalogEntry, ScheduleDeleteResult, ScheduleId, ScheduleUpdateResult } from '@lyness/lyn-schedule/client'
...
describe('Mock detail metrics shared with the task list', () => {
  ...
  it('states the Plugins-aligned list-page column, heading, search field, and row metrics', () => {
    ...
    expect(stylesheet).toMatch(
      /\[data-platform='darwin'\][^{]*\.pageHeading\s*\{[^}]*padding-top:\s*calc\(28px \+ var\(--lyn-frame-top-clearance, 0px\)\);/,
    )
