/**
 * Package-owned invariant companion for `@lyness/client-ui-message-feedback`.
 * @module @lyness/client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-message-feedback'
