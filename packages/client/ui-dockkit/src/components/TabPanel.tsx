...
import { IconCloseFillRegular, IconPlusOutlineRegular, Tooltip } from '@lyness/lyn-client-ui-primitives'
...
/** The split control's glyph from the shared product artwork. */
