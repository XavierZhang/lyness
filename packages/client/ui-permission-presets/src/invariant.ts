/**
 * Package-owned invariant companion for `@lyness/client-ui-permission-presets`.
 * @module @lyness/client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-permission-presets'
