...
import { remoteDefaultResponses } from '@lyness/lyn-client-test-runtime/src/assembly/remote-default-responses.ts'
...
import { PopupSelectController } from '@lyness/lyn-client-ui-commands/client'
import type {
  PermissionCatalog, PermissionSelection,
} from '@lyness/lyn-permission-presets/client'
import {
