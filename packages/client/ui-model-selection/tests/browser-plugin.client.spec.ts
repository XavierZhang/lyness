...
import { createScope } from '@lyness/api-session-controller/client'
...
import type { ModelSelection, ModelSelectionProjection } from '@lyness/api-session-controller/types'
import type { CommandContribution, PopupSelectSpec, SelectOption } from '@lyness/client-ui-commands/client'
