/**
 * Package-owned invariant companion for `@lyness/client-ui-model-selection`.
 * @module @lyness/client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-model-selection'
