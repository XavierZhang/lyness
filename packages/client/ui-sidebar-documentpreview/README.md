...
Both HTML modes set the initial iframe name to `lyn-sidebar-html-<tab-id>` for Desktop shortcut routing. This correlation does not grant the preview access to the parent document.
