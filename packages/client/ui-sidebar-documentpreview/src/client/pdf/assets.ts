...
declare global {
  ...
  const __LYNESS_PDFJS_ASSETS__: PdfAssetMap
}
 ...
 */
export function createPdfBinaryDataFactory(assets: PdfAssetMap = __LYNESS_PDFJS_ASSETS__): new () => PdfBinaryDataFactory {
