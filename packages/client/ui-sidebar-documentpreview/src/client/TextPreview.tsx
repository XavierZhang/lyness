...
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@lyness/client-ui-slots'
import { FileTypeIcon, IconRefreshOutline16, Menu, Tooltip, classifyFileType } from '@lyness/client-ui-primitives'
