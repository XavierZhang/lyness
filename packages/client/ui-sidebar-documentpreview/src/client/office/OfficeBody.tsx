...
import type { PropsLocale, PropsRenderSlots, PropsStore, SlotHookFactory } from '@lyness/lyn-client-ui-slots'
import type { TabId } from '@lyness/lyn-client-ui-dockkit'
import { Button, FileTypeIcon, classifyFileType } from '@lyness/lyn-client-ui-primitives'
...
export function OfficeBody(props: OfficeBodyProps): ReactNode {
  ...
  return <div className={css.body}>
    ...
    }, { entryKey: '@lyness/lyn-client-ui-sidebar-documentpreview/office', hookContext: props.useTabInfo })}
  </div>
}
