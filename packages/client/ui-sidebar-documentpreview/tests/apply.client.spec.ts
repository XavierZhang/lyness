...
describe('ui-sidebar-documentpreview apply', () => {
  it('registers the type, its dictionaries, and the body and title seats under the type\'s id, the body with a store and a face', async () => {
    ...
    expect(registered.map(entry => [entry.name, entry.key, entry.locale, entry.component])).toEqual([
      ...
      ['sidebar.right.tab.document.action', '@lyness/lyn-client-ui-sidebar-documentpreview/office', 'sidebarOffice', OfficeFontAction],
      ['sidebar.right.tab.document', '@lyness/lyn-client-ui-sidebar-documentpreview/office', 'sidebarOffice', OfficeBody],
      ['sidebar.right.tab.document.office.pdf', '@lyness/lyn-client-ui-sidebar-documentpreview/office', 'sidebarPdf', LazyPdfBody],
      ['sidebar.right.tab.document', '@lyness/lyn-client-ui-sidebar-documentpreview/excel', 'sidebarExcel', LazyExcelBody],
      ['sidebar.right.tab.document', '@lyness/lyn-client-ui-sidebar-documentpreview/code', 'sidebarCodePreview', CodeBody],
    ])
  ...
  it('keeps specialized previews first and offers Code for shared highlighting suffixes', async () => {
    ...
    const sharedHighlighter = '@lyness/lyn-client-ui-sidebar-documentpreview/code'
    ...
    const excel = '@lyness/lyn-client-ui-sidebar-documentpreview/excel'
