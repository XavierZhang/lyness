...
import type { RemoteFailure, RemoteResult } from '@lyness/lyn-api-remotes/client'
import type { ResourceSnapshot } from '@lyness/lyn-client-resources/client'
import type { SessionId } from '@lyness/lyn-session/types'
import type { WorkspaceFileStat, WorkspaceFileText } from '@lyness/lyn-api-workspace-files/types'
...
export const ADDRESS = 'lyn-resource://file/session/s-1/work/notes.md'
