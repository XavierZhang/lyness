...
function props(value: DocumentContent, t: MarkdownBodyProps['t'] = makeTranslate(en), absolutePath?: string): MarkdownBodyProps {
  return {
    resourceAddress: 'lyn-resource://file/session/markdown/notes.md', content: value, wrap: false, t,
    useResource: () => ({
...
describe('MarkdownBody', () => {
  it.each(['http://localhost/', 'lyn-app://app/'])('loads document images and failure text under %s', (base) => {
