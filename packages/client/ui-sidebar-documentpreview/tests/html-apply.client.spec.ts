...
describe('HTML registration', () => {
  ...
  it('registers its dictionary and matching keyed body, and removes all contributions on disposal', async () => {
    ...
    await injected?.readRelated('lyn-resource://file/session/explicit-session/sub/index.html', '../app.js', signal)
    ...
    expect(() => injected?.readRelated('lyn-resource://file/absolute/workspace/index.html', './app.js', signal))
