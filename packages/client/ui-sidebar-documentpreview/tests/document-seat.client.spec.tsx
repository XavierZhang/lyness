...
import { apply as resourcesApply, inject as resourcesInject } from '@lyness/client-resources/src/client/index.ts'
import { apply as sidebarApply, inject as sidebarInject } from '@lyness/client-ui-sidebar-right/src/client/index.ts'
