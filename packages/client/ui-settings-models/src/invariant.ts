/**
 * Package-owned invariant companion for `@lyness/client-ui-settings-models`.
 * @module @lyness/client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-settings-models'
