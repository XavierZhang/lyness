---
description: "Models settings and product-onboarding plugin for the lyn web client: provider rows, API-key management, model lists, and the DeepSeek first-run dialogs."
