---
description: "The agent loop's settings page on the lyn web client's Plugins page: the parallel tool-call cap of the agent-loop namespace."
kind: "package-reference"
---

# @lyness/lyn-client-ui-settings-agent-loop
