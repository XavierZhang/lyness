...
import { ConversationNodeAssembler, type TurnLocation } from '@lyness/lyn-client-ui-conversation/client'
import type { SessionLiveEventEntry } from '@lyness/lyn-api-session-controller/client'
import type { ChatNode, ChatSnapshot } from '@lyness/lyn-client-ui-chat/client'
...
describe('submitted plan identity', () => {
  ...
  it('round-trips opaque identifiers and refuses malformed addresses', () => {
    ...
    for (const address of ['file:///plan.md', 'lyn-resource://plan/s/c/extra', 'lyn-resource://plan/s/%XX', 'lyn-resource://plan/s/c?text=x',
      'lyn-resource://plan//c', 'lyn-resource://plan/subagent/p/c/invalid/call', 'lyn-resource://plan/subagent/p/c/one-shot']) {
