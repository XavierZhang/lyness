/** Package-owned invariant companion. @module @lyness/client-ui-settings-plugin-inventory/invariant */

/* jscpd:ignore-start */
import type { Context } from '@lyness/cordis'
import type { InvariantInstaller } from '@lyness/invariants'

const PACKAGE_NAME = '@lyness/client-ui-settings-plugin-inventory'
