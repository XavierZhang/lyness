...
import { apply, inject } from '@lyness/lyn-client-ui-settings-plugins/client'
import type { PluginsSettingsSectionInjected } from '@lyness/lyn-client-ui-settings-plugins/client'
