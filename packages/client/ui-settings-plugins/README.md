---
description: "Built-in plugins settings section for the lyn web client: the Settings navigation entry and the tab chrome that feature-owned tabs register into."
