/**
 * Package-owned invariant companion for `@lyness/client-ui-settings-plugins`.
 * @module @lyness/client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-settings-plugins'
