---
description: "The shell executor's settings page on the lyn web client's Plugins page: the command timeout and the per-stream output cap of the shell namespace."
kind: "package-reference"
---

# @lyness/lyn-client-ui-settings-shell
