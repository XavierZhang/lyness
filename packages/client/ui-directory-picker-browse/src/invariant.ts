/**
 * Package-owned invariant companion for `@lyness/client-ui-directory-picker-browse`.
 * @module @lyness/client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-directory-picker-browse'
