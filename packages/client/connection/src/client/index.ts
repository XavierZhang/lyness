...
interface ClientTransportGlobal {
  ...
  __LYNESS_CONNECTION_RECOVERY__?: unknown
}
...
export function apply(ctx: Context): void {
  ...
  const transport = globals.__LYNESS_TRANSPORT__
  installConnection(ctx, {
    ...(transport === undefined ? {} : { transport }),
    recovery: resolveConnectionConfig(globals.__LYNESS_CONNECTION_RECOVERY__),
