...
import { SegmentedControl } from '@lyness/lyn-client-ui-primitives'
...
describe('SegmentedControl', () => {
  ...
  it('places the sliding indicator by selected index and option count', () => {
    ...
    expect(list.style.getPropertyValue('--lyn-segment-count')).toBe('3')
    expect(list.style.getPropertyValue('--lyn-segment-index')).toBe('2')
  })
