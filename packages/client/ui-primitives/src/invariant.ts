/**
 * Package-owned invariant companion for `@lyness/client-ui-primitives`.
 * @module @lyness/client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-primitives'
