...
// The single extension table is owned by `@lyness/lyn-util-code-language`,
...
export { CODE_HIGHLIGHT_EXTENSIONS, languageForPath } from '@lyness/lyn-util-code-language'
