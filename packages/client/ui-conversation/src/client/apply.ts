...
import type { ISessions, SessionBinding } from '@lyness/lyn-api-session-controller/client'
import { IconPaperclipOutlineRegular } from '@lyness/lyn-client-ui-primitives'
...
import type { ShortcutCommandId, ShortcutFixedCommand } from '@lyness/lyn-client-shortcuts/client'
...
import { relativizeToCwd, workspaceTitleOf } from '@lyness/lyn-util-workspace-path'
...
function hostPathBridge(): HostPathBridge | undefined {
  return (globalThis as { __LYNESS_HOST_PATHS__?: HostPathBridge }).__LYNESS_HOST_PATHS__
}
