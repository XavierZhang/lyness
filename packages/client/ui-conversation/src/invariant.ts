/**
 * Package-owned invariant companion for `@lyness/client-ui-conversation`.
 * @module @lyness/client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-conversation'
