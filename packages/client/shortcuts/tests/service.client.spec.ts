...
afterEach(async () => {
  ...
  Reflect.deleteProperty(window, 'lynDesktop')
  localStorage.clear()
  vi.restoreAllMocks()
})
...
function desktop() {
  ...
  Object.defineProperty(window, 'lynDesktop', { configurable: true, value: { shortcuts: api, keyboard } })
...
it.each(['darwin', 'win32', 'linux'])('rejects %s Desktop startup without its native keyboard bridge', (platform) => {
  ...
  Object.defineProperty(window, 'lynDesktop', { configurable: true, value: { shortcuts: api } })
