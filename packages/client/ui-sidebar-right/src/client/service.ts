...
import { activeDockPaneId, canSplit, findContentTab, dockPaneIds, findTabPane, getPane } from '@lyness/lyn-client-ui-dockkit'
...
const RESOURCE_SCHEME = 'lyn-resource://'
