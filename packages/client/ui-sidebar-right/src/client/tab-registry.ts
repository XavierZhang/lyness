 ...
 * (`lyn-resource://file/**`, `sidebar://guide`) rather than the URI's path.
 *
...
export interface SidebarRightTabDefinition {
   ...
   * (`lyn-resource://file/**`); one without is matched against the URI's path at
   * any depth (`*.md` matches `lyn-resource://file/session/s1/home/me/notes.md`),
 ...
 * against. `lyn-resource://file/session/s1/home/me/b.md` gives `/session/s1/home/me/b.md`;
