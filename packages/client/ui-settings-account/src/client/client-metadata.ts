 ...
 * @module @lyness/lyn-client-ui-settings-account/src/client/client-metadata
 */
import type { AccountClientMetadata } from '@lyness/lyn-deepseek-account/types'
...
export function accountClientMetadata(locale: string, version: string | undefined): AccountClientMetadata {
  if (version === undefined || version === '') throw new Error('account: this client build carries no LYNESS_CLIENT_VERSION')
  return {
    version,
    locale,
