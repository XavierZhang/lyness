...
The generated [configuration catalog](../../../docs/config-catalog.md#lynessclient-hmr) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynessclient-hmr) — every accepted config field and its source declaration.
