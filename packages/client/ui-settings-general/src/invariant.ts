/**
 * Package-owned invariant companion for `@lyness/client-ui-settings-general`.
 * @module @lyness/client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-settings-general'
