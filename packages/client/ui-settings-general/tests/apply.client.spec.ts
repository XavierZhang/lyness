...
import { ok, type RemoteMock } from '@lyness/lyn-remote-mock'
import type { SettingsNamespaceView } from '@lyness/lyn-settings/types'
...
import { LOCALE_SETTINGS_NAMESPACE, LocaleSettingsSchema } from '@lyness/lyn-client-locale/src/locale-settings.ts'
...
const SELF = '@lyness/lyn-client-ui-settings-general'
