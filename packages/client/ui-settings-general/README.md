...
The current release version appears at the bottom of General Settings in Web and Desktop, using the build’s `LYNESS_CLIENT_VERSION` metadata and the active language. Partial builds without version metadata omit the row.
