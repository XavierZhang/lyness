...
const BUILTINS = {
  goal: '@lyness/lyn-command-goal',
  plan: '@lyness/lyn-plan-mode',
  feedback: '@lyness/lyn-command-feedback',
  compact: '@lyness/lyn-command-compact',
  permission: '@lyness/lyn-permission-presets',
  export: '@lyness/lyn-session-log-export',
} as const
