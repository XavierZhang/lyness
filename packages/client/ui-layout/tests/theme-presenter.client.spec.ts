...
import type { ThemePreference, ThemeSnapshot } from '@lyness/lyn-client-ui-theme/client'
import { DARK_ATTRIBUTE, THEME_SOURCE_ATTRIBUTE, ThemePresenter } from '@lyness/lyn-client-ui-layout/src/client/theme-presenter.ts'
...
describe('ThemePresenter', () => {
  ...
  it('dispose removes color-scheme, the attribute, the font-size axis, and every applied variable, sparing foreign inline styles', () => {
    ...
    expect(document.body.style.getPropertyValue('--lyn-content-font-size')).toBe('')
