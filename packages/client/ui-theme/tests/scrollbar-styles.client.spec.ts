...
const INDIRECTION_PREFIX = '--lyn-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--lyn-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--lyn-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--lyn-scrollbar-width)`); a rename in scrollbar.css without
