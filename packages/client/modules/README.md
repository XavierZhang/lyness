...
- **No unload bookkeeping of its own** — style removal and fiber teardown ordering live with the HMR driver (`@lyness/client-hmr`); the loader only inventories owned style tag ids per record.
