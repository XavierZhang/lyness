 ...
 * `lyn-resource://<type>/…` URL: the host names the protocol. The protocol's
 ...
 * encodes it in the path, as `lyn-resource://file/session/<sessionId>/<absolute
...
import type { ResourceProtocolMap } from '@lyness/lyn-client-ui-slots'
...
export interface ResourceProvider<P extends ResourceProtocol> {
   ...
   * @param address - the full address, a `lyn-resource://<type>/…` URL.
