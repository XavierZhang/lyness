...
export const SUBAGENT_CHAT_ID = '@lyness/lyn-client-ui-subagent'

/** Resource-address prefix for an embedded Session chat. */
export const SUBAGENT_CHAT_ADDRESS = 'lyn-resource://subagentchat/session/'
...
export function parseSubagentChatAddress(value: string): SubagentAddress | undefined {
  ...
  if (url.protocol !== 'lyn-resource:' || url.hostname.toLowerCase() !== 'subagentchat') return undefined
