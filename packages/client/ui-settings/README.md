---
description: "Settings domain base plugin: shared configuration forms, schema service, and the canonical settings slot-type contract for the lyn web client."
