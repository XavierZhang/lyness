/**
 * Package-owned invariant companion for `@lyness/client-ui-reference`.
 * @module @lyness/client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-reference'
