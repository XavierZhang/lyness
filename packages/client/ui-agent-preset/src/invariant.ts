/**
 * Package-owned invariant companion for `@lyness/client-ui-agent-preset`.
 * @module @lyness/client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-agent-preset'
