...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  sectionIntro: 'Choose the agent’s tools and how it works. Use Standard mode for everyday tasks, or Creator mode to add capabilities to LYN.',
  ...
  presetCordisDescription:
    'Customize LYN through conversation. Let the agent write plugins that add features or UI, or combine tools and prompts to create your own mode.',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  sectionIntro: '选择 Agent 的工具和工作方式。日常任务用「标准模式」，扩展 LYN 的能力用「创造模式」。',
  ...
  presetCordisDescription: '用对话定制 LYN：让 Agent 编写插件，添加新功能或界面；也能组合工具和提示词，创建自己的模式。',
...
// The resolution itself is the shared fold in `lyn-agent-preset-registry/display`,
...
export { isBuiltInPreset, presetDisplayText } from '@lyness/lyn-agent-preset-registry/display'
export type { PresetDisplaySource, PresetDisplayText } from '@lyness/lyn-agent-preset-registry/display'
