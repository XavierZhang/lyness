...
export const zh = {
  ...
  'web-document': '当前网站本地存储中的 lyn.keybindings.v1', 'desktop-document': 'userData/keybindings.json',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'web-document': 'this site’s localStorage entry lyn.keybindings.v1', 'desktop-document': 'userData/keybindings.json',
