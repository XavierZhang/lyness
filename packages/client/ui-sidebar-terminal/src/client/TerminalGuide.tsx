...
import { PluginArtworkTerminal, ShortcutKeys, Button, IconChevronDownOutlineRegular, Menu } from '@lyness/lyn-client-ui-primitives'
import type { TerminalLaunchShells } from '@lyness/lyn-api-terminal-controller/client'
