...
it('preserves indexed, extended and default application colors while updating LYN selection colors', () => {
  const h = harness()
...
it('restores selected entries, all indexed colors and special colors to the current LYN defaults', () => {
  const h = harness()
