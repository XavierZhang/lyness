...
import type { ShortcutCommand } from '@lyness/lyn-client-shortcuts/client'
import { afterEach, expect, it, vi } from 'vitest'
import type { SessionId } from '@lyness/lyn-session/types'
import type { WebTerminalId, WebTerminalInfo } from '@lyness/lyn-api-terminal-controller/types'
import { SidebarRightTabRegistry } from '@lyness/lyn-client-ui-sidebar-right/src/client/tab-registry.ts'
import type { SidebarRightCloseHandler } from '@lyness/lyn-client-ui-sidebar-right/client'
import type { SidebarRightOpenTab } from '@lyness/lyn-client-ui-sidebar-right/client'
