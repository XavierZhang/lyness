/**
 * Package-owned invariant companion for `@lyness/client-ui-directory-picker-native`.
 * @module @lyness/client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-directory-picker-native'
