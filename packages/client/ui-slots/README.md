---
description: "Slot registry pure core for the lyn web client: ordinary extension slots, reusable Component Factories, derived props types, store seats, and the renderer install contract."
