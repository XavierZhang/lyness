/**
 * Package-owned invariant companion for `@lyness/client-ui-attachment`.
 * @module @lyness/client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-ui-attachment'
