 ...
 * comparison at a time. It claims the `lyn-resource://changes-review/session/…`
...
export const CHANGES_REVIEW_ID = '@lyness/lyn-client-ui-deliverables'
...
export function changesReviewDefinition(t: TranslateNS<typeof NS>): SidebarRightTabDefinition {
  return {
    ...
    patterns: ['lyn-resource://changes-review/**'],
    priority: 'builtin',
