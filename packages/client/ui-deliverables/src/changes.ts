...
import type { WorkspaceChangedFile, WorkspaceChangesSummary, WorkspaceDiffHunk, WorkspaceFileDiff } from '@lyness/lyn-workspace-changes/types'
...
export const CHANGES_REVIEW_ADDRESS = 'lyn-resource://changes-review/session/'
 ...
 * @returns a `lyn-resource://changes-review/session/…` address.
 */
