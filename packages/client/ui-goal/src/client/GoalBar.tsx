...
import type { GoalSnapshot } from '@lyness/goal/client'
import {
...
export type GoalDockProps = import('@lyness/client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
