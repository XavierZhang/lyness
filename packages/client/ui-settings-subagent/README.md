---
description: "The Subagent settings page on the lyn web client's Plugins page: delegation depth and capacity over the subagent namespace, and the models agents may choose over subagent-model-selection, on one page with one save."
kind: "package-reference"
---

# @lyness/lyn-client-ui-settings-subagent
