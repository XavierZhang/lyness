...
export const zh = {
  ...
  installSpecPlaceholder: '例如 @lyness/lyn-subagent-codex',
  installGuideToggle: '插件安装引导和示例',
  installGuideHide: '收起引导',
  installGuideIdTitle: '包名',
  installGuideIdExample: '@lyness/lyn-subagent-codex',
  installGuideIdHint: '插件包名即 npm 包名（如 lyn-xxx 或 @作者/插件名），社区插件的 README 安装命令中 lyn plugin add 或 pnpm add 之后的部分。',
  installGuideGitTitle: 'GitHub 仓库地址',
  installGuideGitExample: 'https://github.com/author/lyn-plugin',
...
export const en = {
  ...
  installSpecPlaceholder: 'for example @lyness/lyn-subagent-codex',
  installGuideToggle: 'Install guide and examples',
  installGuideHide: 'Hide the guide',
  installGuideIdTitle: 'Package name',
  installGuideIdExample: '@lyness/lyn-subagent-codex',
  installGuideIdHint: 'The plugin package name is the npm package name (like lyn-xxx or @author/plugin): the part after lyn plugin add or pnpm add in a community plugin\'s README install command.',
