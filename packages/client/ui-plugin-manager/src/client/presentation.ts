...
import type { IncompatiblePlugin, ManagementError, Registry } from '@lyness/lyn-api-remotes/client'
...
export function shortName(name: string): string {
  ...
  return unscoped.replace(/^lyn-(?:host-|client-)?/, '')
}
...
export function packageText(
  ...
  return {
    ...
    beta: pkg.name.startsWith('@lyness/lyn-experimental-'),
  }
}
