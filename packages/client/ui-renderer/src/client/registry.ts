...
import { SlotCore, StaleAuthorizationError, standardHookPropName } from '@lyness/lyn-client-ui-slots'
import type {
...
export class SlotRegistry extends Service {
  ...
  private rebuildRootBinding(): void {
    ...
    const keyedHooks: Record<string, import('@lyness/lyn-client-ui-slots').KeyedStandardSource> = {}
