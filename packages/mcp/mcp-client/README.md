...
The generated [configuration catalog](../../../docs/config-catalog.md#lynessmcp-client) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynessmcp-client) — every accepted config field and its source declaration.
...
- An explicit LYN-owned connection and discovery timeout is an open direction; the SDK's 60-second default bounds startup and teardown.
