...
import type { EntryInfo, Sandbox } from '@lyness/lyn-e2b'

const VERSION_METADATA_KEY = 'lyn-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.lyn-${randomUUID()}.tmp`)
