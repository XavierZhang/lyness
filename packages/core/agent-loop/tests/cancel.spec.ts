 ...
 * @module lyn-agent-loop/tests/cancel
 */
...
import AgentRegistry, { type Agent, type AgentCancelCause } from '@lyness/lyn-agent'
...
describe('Agent.cancel()', () => {
  ...
  it('cancel during error recovery does not finalize the failed stream', async () => {
    ...
    // lyn-llm-retry opens when its backoff waits after appending llm/retry.
