/**
 * Package-owned invariant companion for `@lyness/agent-tool-presentation`.
 * @module @lyness/agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@lyness/agent-tool-presentation'
 ...
 * registry's to hold, and `lyn-tools` observes it there.
 */
