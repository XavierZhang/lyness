 ...
 * @module @lyness/lyn-agent-presets/discovery
 */
 ...
 *
 * This package owns the writable root the way `lyn-skill-filesystem` owns
 * `<lynHome>/skills`: where a person's own presets go is the same place in
