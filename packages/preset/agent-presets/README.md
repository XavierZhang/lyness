...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-agent-presets) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesslyn-agent-presets) — every accepted config field and its source declaration.
