/**
 * Package-owned invariant companion for `@lyness/lyn-agent-preset-registry`.
 * @module @lyness/lyn-agent-preset-registry/invariant
 */
...
import { leakedServices, livePresetMounts } from '@lyness/lyn-agent-preset-registry'

const PACKAGE_NAME = '@lyness/lyn-agent-preset-registry'
