 ...
 *
 * `lyn-system-prompt` owns the global persona as its own config, and registers
 ...
 * exactly like the per-child persona `lyn-subagent` installs; mounted globally
...
import { PERSONA_ORDER, PERSONA_SECTION } from '@lyness/system-prompt'
