...
import { parseBootManifest } from '@lyness/lyn-client-modules/client'
import type { WebBootGraph } from '@lyness/lyn-client-modules/client'
import * as uiRenderer from '@lyness/lyn-client-ui-renderer/client'
import * as typertRegistry from '@lyness/lyn-typert-registry/client'
...
const RENDERER = '@lyness/lyn-client-ui-renderer'
const TYPERT = '@lyness/lyn-typert-registry'
const BRAND = '@lyness/lyn-client-ui-brand-official'
const MISSING = '@lyness/lyn-client-does-not-exist'
...
describe('createInProcessModules', () => {
  it('serves import() and prefetch() from registered factories and never loads a bundle', async () => {
    ...
    await expect(system.import('@lyness/lyn-client-unknown', '', {})).rejects.toThrow('cannot resolve')
  })
