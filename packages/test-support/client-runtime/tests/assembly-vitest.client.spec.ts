...
const test = createClientTest({ roster: webApp.closure(['@lyness/lyn-api-gateway']) })
...
const missingConnection = createClientTest({ roster: webApp.pick(['@lyness/lyn-typert-registry']) })
