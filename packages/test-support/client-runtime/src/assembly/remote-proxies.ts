 ...
 * @module @lyness/lyn-client-test-runtime/src/assembly/remote-proxies
 */
import type { Context } from '@lyness/cordis'
import { cancelledFailure, carrierFailure } from '@lyness/lyn-api-gateway/client'
...
export const REMOTES_PACKAGE = '@lyness/lyn-api-remotes'
