 ...
 * @module @lyness/lyn-client-test-runtime/src/assembly/modules
 */
import * as modulesClient from '@lyness/lyn-client-modules/client'
import { createClientModuleSystem } from '@lyness/lyn-client-modules/client'
import type { ClientModuleLoader, ClientModuleLoaderTarget, WebBootGraph } from '@lyness/lyn-client-modules/client'
...
export const MODULES_PACKAGE = '@lyness/lyn-client-modules'
 ...
 * statically imported `@lyness/lyn-client-modules/client` namespace.
