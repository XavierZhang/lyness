/**
 * Package-owned invariant companion for `@lyness/client-test-runtime`.
 * @module @lyness/client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@lyness/client-test-runtime'
