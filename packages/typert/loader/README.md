...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesstypert-loader) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesstypert-loader) — the `packages` field declaration and JSDoc.
