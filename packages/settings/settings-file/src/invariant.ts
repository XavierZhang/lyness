/**
 * Package-owned invariant companion for `@lyness/settings-file`.
 * @module @lyness/settings-file/invariant
 */
...
const PACKAGE_NAME = '@lyness/settings-file'
 ...
 * tests; the in-process commit relation is owned by `@lyness/settings`.
 */
