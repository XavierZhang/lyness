...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesslyn-skill) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#lynesslyn-skill) — every config field and its source declaration.
