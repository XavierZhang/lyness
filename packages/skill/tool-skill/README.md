...
The generated [configuration catalog](../../../docs/config-catalog.md#lynesstool-skill) is the exhaustive source for every accepted field.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#lynesstool-skill) — the exact `skill` schema the model receives.
...
The model sees the generated [`skill` schema](../../../docs/tool-catalog.md#lynesstool-skill).
