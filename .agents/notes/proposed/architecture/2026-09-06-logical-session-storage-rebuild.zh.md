...
- [`@lyness/lyn-session`](../../../../packages/core/session/README.zh.md)拥有会话包约定。
- [`@lyness/lyn-session-persistence`](../../../../packages/session/session-persistence/README.zh.md)拥有当前持久化服务约定。
