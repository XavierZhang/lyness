...
- [`@lyness/lyn-session`](../../../../packages/core/session/README.md) owns the session package contract.
- [`@lyness/lyn-session-persistence`](../../../../packages/session/session-persistence/README.md) owns the current persistence service contract.
