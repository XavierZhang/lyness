...
The invariant reaches compositions loading `lyn-invariants`. Production entry points must compose Agents explicitly; installing the registry alone does not bind them.
