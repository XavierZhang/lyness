...
LYN grants authenticate Platform, inference and Files requests with x-lyn-auth-token, without a Bearer prefix. API-key authentication remains protocol-specific.
