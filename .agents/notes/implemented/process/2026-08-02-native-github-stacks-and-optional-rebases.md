...
The [stack landing skill](../../../skills/lyn-merging-stacked-prs/SKILL.md) verifies native support, same-repository branches, live authors, official membership and order, merge range, and final merged state. The [stack review guide](../../../../docs/cookbook/responding-to-pr-review-on-a-stack.md) keeps fixes on their introducing layer and covers both propagation histories. The [pre-push workflow](../../../skills/lyn-pre-push-checks/SKILL.md) owns lease protection and immediate post-sync evidence.
