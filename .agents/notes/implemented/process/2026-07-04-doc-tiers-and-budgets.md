...
- **A thin workflow skill, contracts in docs.** [.agents/skills/lyn-doc](../../../skills/lyn-doc/SKILL.md) carries the placement, audit, budget, and website workflow and defers to the standard as its source of truth, the same split as [lyn-translate-docs](../../../skills/lyn-translate-docs/SKILL.md) over the i18n contract.
