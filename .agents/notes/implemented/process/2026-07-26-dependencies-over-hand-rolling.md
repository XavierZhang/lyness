...
- Agents and contributors surveying for simplifications now treat "replace hand-rolled X with package Y" as in-scope output; [lyn-find-simplifications](../../../skills/lyn-find-simplifications/SKILL.md) carries the corresponding guidance.
