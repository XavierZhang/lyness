...
The entry point separates decision criteria from an [optional historical reference](../../../skills/lyn-find-simplifications/references/historical-patterns.md) pairing mechanisms with counterexamples and residual obligations. Archive mechanics remain at their existing owner, and the proposal skeleton uses the canonical headings.
