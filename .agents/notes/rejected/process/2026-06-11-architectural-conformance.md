...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@lyness/agent-loop`.
- No cross-package deep imports (`@lyness/*/src/...` paths) — public entry points only.
