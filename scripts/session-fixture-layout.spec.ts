...
import { scrubSessionSnapshot } from '@lyness/lyn-session-snapshot'
import {
...
describe('isPhysicalSessionFixture', () => {
  it('recognizes fixtures that preserve physical persistence encoding', () => {
    ...
    expect(isPhysicalSessionFixture(
      'packages/experimental/webworker-runtime/tests/fixtures/vfs-example/home/sessions/--lyn-workspace--/main/session.v1.jsonl',
    )).toBe(true)
    expect(isPhysicalSessionFixture(
