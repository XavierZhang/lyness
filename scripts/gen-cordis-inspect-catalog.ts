...
import type { CordisCatalogModel, ServiceMethodEntry } from '@lyness/typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@lyness/tool-cordis/api-catalog', '@lyness/cordis-client-runner/client/api-catalog')
