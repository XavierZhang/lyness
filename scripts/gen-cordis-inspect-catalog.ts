...
import type { CordisCatalogModel, ServiceMethodEntry } from '@lyness/lyn-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@lyness/lyn-tool-cordis/api-catalog', '@lyness/lyn-cordis-client-runner/client/api-catalog')
