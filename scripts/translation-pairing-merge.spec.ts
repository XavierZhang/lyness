...
function createFixture(attributes = true): Fixture {
  ...
  if (attributes) write(root, '.gitattributes', '*.i18n.yaml merge=lyn-translation-pairing\n')
  return fixture
}
...
// The value matches LYNESS_COVERAGE_TEST_TIMEOUT_MS, which the Windows coverage
