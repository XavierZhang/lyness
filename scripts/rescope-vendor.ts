...
const EXACT_EDITS: readonly ExactEdit[] = [
  {
    ...
    replace: "import type Schema from '@lyness/schemastery'",
    expect: 1,
  },
  {
...
`,
  ...
  },
  {
    ...
    replace: 'vendor is [rescoped](docs/rescope.md) and `private: true`. Harness packages declare `@lyness/cordis` in `peerDependencies`/`devDependencies`.',
    expect: 1,
  },
  {
