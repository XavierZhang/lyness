...
function checkManifest(
  ...
  if (manifest.peerDependencies?.['@lyness/invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
  ...
  if (manifest.devDependencies?.['@lyness/invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@lyness/invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@lyness/invariants'
