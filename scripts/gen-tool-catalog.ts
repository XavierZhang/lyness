...
import type { SubagentProvider, SubagentReportDelivery } from '@lyness/subagent'
...
import * as ToolSubagentReport from '@lyness/tool-subagent-report'
...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  {
    pkg: '@lyness/tool-subagent-report',
  ...
  },
  {
    ...
    scope: ctx => catalogChildScopes.get(ctx) as Agent,
    note:
      'All ten tools are scoped to implicit Team Leads and durable teammates. The shipped lyn-base bundle keeps the package disabled; the documented Agent Teams profile patch enables it while disabling the legacy continuable-child control names.',
  },
  {
