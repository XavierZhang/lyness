...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  agents: 'core.md',
  tenants: 'multi-tenancy.md',
  tenantConfig: 'multi-tenancy.md',
  requestTenant: 'multi-tenancy.md',
  tenantController: 'multi-tenancy.md',
 ...
 * The scan that enforces this list reads EVERY `declare module '@lyness/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  lynHomePath: 'not a service: boot-provided root accessor function (typeof lynHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
 ...
 * scan reads EVERY `declare module '@lyness/cordis'` Events merge under
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  Tenant: 'multi-tenancy.md',
  TenantConfig: 'multi-tenancy.md',
  TenantConfigCapability: 'multi-tenancy.md',
  TenantIdentity: 'multi-tenancy.md',
  RequestTenant: 'multi-tenancy.md',
  TenantConfigInput: 'multi-tenancy.md',
  TenantConfigView: 'multi-tenancy.md',
  ModalityModels: 'multi-tenancy.md',
  ModelChoice: 'multi-tenancy.md',
  ProviderGrant: 'multi-tenancy.md',
  Modality: 'multi-tenancy.md',
  TenantId: 'multi-tenancy.md',
