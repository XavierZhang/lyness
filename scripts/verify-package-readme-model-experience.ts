...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/ptc-runtime/ptc-runtime': { kind: 'indirect', reason: 'The service interface delegates model rendering to PTC mode in lyn-tools.' },
  ...
  'packages/ptc-runtime/ptc-runtime-node': { kind: 'indirect', reason: 'The Node process backend delegates model rendering to PTC mode in lyn-tools.' },
  'packages/experimental/ptc-runtime-python': { kind: 'indirect', reason: 'Explicit source-checkout compositions delegate model rendering to PTC mode in lyn-tools.' },
  ...
  'packages/client/ui-schedule': { kind: 'none', reason: 'Browser-side catalog, editing, and deletion of Host Schedule records; lyn-schedule owns the model-facing tools and delivery.' },
  ...
  'packages/skill/skill-office': { kind: 'indirect', reason: 'The bundled Office provider delegates model rendering to lyn-tool-skill.' },
