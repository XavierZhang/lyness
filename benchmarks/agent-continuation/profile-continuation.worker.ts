...
async function run(root: string): Promise<ProfileReport> {
  ...
  await writeFile(patch, [
    ...
    '- insert:',
    '    - id: fs-local', "      name: '@lyness/fs-local'",
    '    - id: str-replace-editor', "      name: '@lyness/tool-str-replace-editor'",
...
assertBuiltBenchmarkRuntime(import.meta.url, { '@lyness/sdk-client': import.meta.resolve('@lyness/sdk-client') })
