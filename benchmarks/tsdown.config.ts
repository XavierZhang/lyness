...
export default defineConfig([
  ...
  },
  {
    ...
    outDir: '.lyn-build/active-stream-reconnect',
    clean: true,
  ...
  },
  {
    ...
    outDir: '.lyn-build/agent-continuation',
    clean: true,
    tsconfig: 'tsconfig.host.json',
  },
  {
  ...
  },
  {
    ...
    outDir: '.lyn-build/conversation-fold',
    clean: true,
    tsconfig: 'tsconfig.client.json',
  },
])
