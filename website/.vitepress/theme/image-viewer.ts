...
export class ImageViewer {
  ...
  #remove(image: HTMLImageElement, entry: ImageEntry): void {
    ...
    entry.events.abort()
    entry.button.remove()
    entry.container.classList.remove('lyn-image-container')
    image.classList.remove('lyn-image-zoomable')
  ...
  #scan(): void {
    ...
    for (const image of images) {
      ...
      button.className = 'lyn-image-open'
      ...
      container.classList.add('lyn-image-container')
      image.classList.add('lyn-image-zoomable')
