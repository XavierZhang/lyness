...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@lyness/client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@lyness/session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@lyness/token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@lyness/skill-filesystem"}\n',
