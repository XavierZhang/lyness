...
// regression the external report asked for (lyn-external/issues#107 →
// lyness#1406): "increase an 800×720 browser regression test and
...
import type {} from '@lyness/lyn-plan-mode'
