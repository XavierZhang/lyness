...
window.__ModuleLoader__.load({
  ...
  factory(require) {
    ...
    const { MenuItemButton } = require('@lyness/lyn-client-ui-primitives')
    ...
    return {
      ...
      apply(ctx) {
        ...
        ctx.effect(() => {
          ...
          window.addEventListener('lyn-fixture-ping', ping)
          return async () => {
            window.removeEventListener('lyn-fixture-ping', ping)
