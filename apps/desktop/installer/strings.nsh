...
LangString INSTALLER_LAUNCH_FAILED ${LANG_ENGLISH} "lyness could not be launched. Retry, or clear Launch now and close the installer."
LangString INSTALLER_LAUNCH_FAILED ${LANG_SIMPCHINESE} "无法启动 lyness。请重试，或取消勾选立即启动后关闭安装程序。"
...
LangString INSTALLER_RUNNING ${LANG_ENGLISH} "lyness is running. Quit it from the system tray and try again."
LangString INSTALLER_RUNNING ${LANG_SIMPCHINESE} "lyness 正在运行，请先在系统托盘中退出应用后重试。"
...
LangString INSTALLER_PATH_OWNERSHIP ${LANG_ENGLISH} "Choose an empty folder or the registered lyness installation folder."
LangString INSTALLER_PATH_OWNERSHIP ${LANG_SIMPCHINESE} "请选择空文件夹，或 lyness 原来的安装目录。"
