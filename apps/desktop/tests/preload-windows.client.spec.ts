...
afterEach(() => {
  ...
  document.documentElement.style.removeProperty('--lyn-windows-titlebar-height')
...
it('synchronizes live language and palette changes and stops observing a closed document', async () => {
  ...
  expect(document.documentElement.style.getPropertyValue('--lyn-windows-titlebar-height')).toBe('40px')
