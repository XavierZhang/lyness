...
import { ShortcutPersistence } from '@lyness/lyn-client-shortcuts/protocol'
import type { ShortcutConfigSnapshot, ShortcutPlatform } from '@lyness/lyn-client-shortcuts/protocol'
