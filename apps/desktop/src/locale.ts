...
export const en = {
  ...
  startupFailed: 'lyness could not start',
  ...
  updateDetail: 'lyness {version}\n\nThis release includes its matching lyn version. The application will restart after installation.',
  installAndRestart: 'Install and Restart',
  later: 'Later',
  updateFailedTitle: 'Update Failed',
  pluginManagerTitle: 'Desktop Plugins',
  pluginWindowTitle: 'lyness — Desktop Plugins',
...
export const zh = {
  ...
  updateDetail: 'lyness {version}\n\n新版本绑定匹配的 lyn，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: 'lyness — 桌面插件',
