...
import '@lyness/lyn-client-ui-theme/src/styles/design-platform.css'
import '@lyness/lyn-client-ui-theme/src/styles/gradient-shadow-text.css'
...
flushSync(() => { root.render(<Welcome api={window.lynWelcome} />) })
