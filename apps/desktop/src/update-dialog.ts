...
export const UPDATE_DIALOG_IPC = { status: 'lyn-update-dialog:status', changed: 'lyn-update-dialog:changed', respond: 'lyn-update-dialog:respond' } as const
...
const page = 'lyn-app://shell/update-dialog.html'
