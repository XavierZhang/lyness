/** Immutable version identity shared by one Electron shell and its bundled lyn runtime. */
...
export interface DesktopRelease {
  ...
  /** Exact version used by both Electron and `@lyness/lyn`. */
...
export function parseDesktopRelease(value: unknown): DesktopRelease {
  if (!isRecord(value) || value.schemaVersion !== 1 || typeof value.version !== 'string'
    ...
    throw new Error('lyn desktop: invalid desktop release metadata')
  }
  return {
    schemaVersion: 1,
