...
export function resolveDesktopBuildTarget(
  ...
  const arch = env.LYNESS_DESKTOP_TARGET_ARCH ?? env.npm_config_arch ?? hostArch
 ...
 * @returns {{ root: string, artifacts: string, runtime: string, packageSet: string, seed: string, seedPnpm: string, nodeExtract: string, packedLyn: string, packedVendor: string, packedLandlock: string, downloads: string }} Target paths plus the shared immutable download cache.
 */
