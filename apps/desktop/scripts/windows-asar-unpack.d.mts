 ...
 * @param sourceRoot Verified prepared lyn directory; external sources receive a build-owned staging copy.
 ...
 * @param sourceRoot Original signed and sealed lyn directory.
