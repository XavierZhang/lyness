...
async function main(): Promise<void> {
  ...
  const archive = await packagingStep(process.env.LYNESS_DESKTOP_PACKAGING_RUN_DIR, 'download:electron',
  ...
  await packagingStep(process.env.LYNESS_DESKTOP_PACKAGING_RUN_DIR, 'extract:electron', () => extractZip(archive, { dir: BUILD_PATHS.electron }))
  ...
  await packagingStep(process.env.LYNESS_DESKTOP_PACKAGING_RUN_DIR, 'prepare:primary-runtime',
