...
const FATAL_NOTIFICATION = 'LYNESS_DESKTOP_PACKAGING_FATAL'
...
export function createPackagingRun(root, metadata, settings = {}) {
  ...
  async function run(stage, executable, args, options) {
    ...
    try {
      ...
      child = spawn(executable, [...args], { cwd: options.cwd, env: { ...options.env, LYNESS_DESKTOP_PACKAGING_RUN_DIR: directory },
